            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0://HOME
                        ...
                        Intent i3 = new Intent(events.this, home1.class);
                        i3.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i3);
                        break;
                    case 1://ABOUT
                        Intent i2 = new Intent(events.this, attend.class);
                        i2.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i2);
                        break;
                    case 2://INSTRUCTIONS

                    Toast.makeText(events.this, "You're already in this Page!", Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case 4:
                        //Keynote Speaker
                        Intent i4 = new Intent(events.this, keyspeakers.class);
                        i4.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i4);
                        break;
                    case 5:
                        //The sponsors list
                        Intent i5 = new Intent(events.this, Sponsors.class);
                        i5.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i5);
                        break;
                    case 6:
                        Intent i6 = new Intent(events.this, LiveScore.class);
                        i6.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i6);
                        break;
                    case 7:
                        Intent i7 = new Intent(events.this, AboutUs.class);
                        i7.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i7);
                        break;

                    case 8:
                        Intent i8 = new Intent(events.this, ContactUs.class);
